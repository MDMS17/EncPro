...
{
    public class Process834
    {
        public static void Process834Line(string s834Line, char elementDelimiter, ref Elig834 elig834, ref string LoopNumber, ref int lineNumber)
        {
            ...
            switch (segments[0])
            {
                ...
                case "INS":
                    ...
                    {
                        M834Utility.Save834Batch(ref elig834);
                    }
                    LoopNumber = "2000";
